...
CREATE TABLE `booking_services` (
  ...
  CONSTRAINT `booking_services_ibfk_1` FOREIGN KEY (`id_booking`) REFERENCES `booking` (`id`),
  CONSTRAINT `booking_services_ibfk_2` FOREIGN KEY (`id_service`) REFERENCES `services` (`id`)
